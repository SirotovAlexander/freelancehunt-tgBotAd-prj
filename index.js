  ...
  try {
    if (msg.text.startsWith("/start")) {
      await bot.sendMessage(
        msg.chat.id,
        `Hy Vita!\n Для использования бота необходимо сделать два шага: 1)Создать рекламное сообщение.В меню слева есть соответствующая кнопка. Перед любым сформированым рекламным сообщением необходимо поставить знак $.\n 2) Нужно создать массив каналов. Каналы передаются полными ссылками через пробел, пример: https://t.me/nofluffjobsukraine.\n 3)Выполнив эти два шага проверь сооветсвующими функциями из меню бота сохраненное сообщение и масив каналов, после чего нажимай команду flood!\n`
      );
